					...
					<div class="products-tabs">
						...
						<div id="tab1" class="tab-pane active">
							<div class="products-slick" data-nav="#slick-nav-1">
								<!-- product -->
								<?php
								$getSanPhamMoi = $product->getSanPhamMoi();
								foreach ($getSanPhamMoi as $value) : ?>
									<div class="product">
										...
										<a href="addCard.php?id=<?php echo $value['id'] ?>" >
					...
					<div class="products-tabs">
						...
						<div id="tab2" class="tab-pane fade in active">
							<div class="products-slick" data-nav="#slick-nav-2">
								<!-- product -->
								<?php 
								$getTenProducts = $product->getTenProducts();
								foreach ($getTenProducts as $value) : ?>
...
<div class="section">
	...
	<div class="container">
		...
		<div class="col-md-4 col-xs-6">
			...
			<div class="col-md-4 col-xs-6">
				<div class="section-title">
					<h4 class="title">Top selling2</h4>
					<div class="section-nav">
