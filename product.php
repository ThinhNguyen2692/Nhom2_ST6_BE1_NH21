			...
			<div class="container">
				<!-- row -->
					...
					<div class="col-md-5 col-md-push-2">
						...
						<img style="width: 250px;height:500px;" src="./img/<?php echo $value['image'] ?>" alt="">
						</div>
					...
					<div class="col-md-5">
						...
						<h2 class="product-name"><a href="product.php?id=<?php echo $value['id'] ?>"><?php echo $value['name'] ?></a></h2>
							<div>
